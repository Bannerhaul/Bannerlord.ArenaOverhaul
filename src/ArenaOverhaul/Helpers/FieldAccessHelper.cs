...
namespace ArenaOverhaul.Helpers
{
    public static class FieldAccessHelper
    {
        ...
        public static readonly FieldRef<ArenaPracticeFightMissionController, List<CharacterObject>> APFMCParticipantCharactersByRef = FieldRefAccess<ArenaPracticeFightMissionController, List<CharacterObject>>("_participantCharacters");
        ...
        public static readonly FieldRef<ArenaPracticeFightMissionController, List<MatrixFrame>> APFMCInitialSpawnFramesByRef = FieldRefAccess<ArenaPracticeFightMissionController, List<MatrixFrame>>("_initialSpawnFrames");
